 ...
 */
public abstract class Controller extends ControlComponent
{
	/**
	...
	/**
	 * The default entry point for all Simple Framework Servlets on a POST request call,
	...
	/**
	 * The default entry point for all Simple Framework Servlets on a POST request call 
	 * and it contains a plain text content request.
	 * This is called if no matching entry points exist for the desired request method
	 * and file.
	 * Unless overridden, this returns status 405, Method Not Supported.
	 * @param file the requested file (portion of URL - can be blank).
	 ...
	 */
	public void onText(String file, HttpServletRequest request, HttpServletResponse response, String content)
	{
		sendCode(response, 405, "Servlet does not support this method.");
	}
	...
	/**
	 * The default entry point for all Simple Framework Servlets on a POST request call 
	 * and it contains a binary content request.
	 * This is called if no matching entry points exist for the desired request method
	 * and file.
	 * Unless overridden, this returns status 405, Method Not Supported.
	 * @param file the requested file (portion of URL - can be blank).
	 ...
	 */
	public void onBinary(String file, HttpServletRequest request, HttpServletResponse response, byte[] content)
	{
		sendCode(response, 405, "Servlet does not support this method.");
	}

	/**
	 * The default entry point for all Simple Framework Servlets on a HEAD request call.
	 * This is called if no matching entry points exist for the desired request method
	 * and file.
	 * Unless overridden, this returns status 405, Method Not Supported.
	 * @param file the requested file (portion of URL - can be blank).
	...
	/**
	 * The default entry point for all Simple Framework Servlets on a PUT request call.
	 * This is called if no matching entry points exist for the desired request method
	 * and file.
	 * Unless overridden, this returns status 405, Method Not Supported.
	 * @param file the requested file (portion of URL - can be blank).
	...
	/**
	 * The default entry point for all Simple Framework Servlets on a DELETE request call.
	 * This is called if no matching entry points exist for the desired request method
	 * and file.
	 * Unless overridden, this returns status 405, Method Not Supported.
	 * @param file the requested file (portion of URL - can be blank).
